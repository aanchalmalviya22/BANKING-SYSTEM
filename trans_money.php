...
<head>
    ...
    <link rel="stylesheet" href="CSS/trans_money.css">
...
<div class="container mt-5">
    <h2 class="text-center mb-3">Transfer Money</h2>
  ...
  <tbody>
   ...
   ?>
    ...
    <tr>
      ...
      <td><a href="selectuser.php?id= <?php echo $rows['id']; ?>"> <button type="button" class="btn btn-secondary">Transfer</button></a></td>
